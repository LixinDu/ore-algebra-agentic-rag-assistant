...
- Do not add `from sage.all import *` or `from ore_algebra import *`; the runtime adds those automatically.
...
def _loads_json_object(raw_text: str) -> dict:
    ...
    try:
        ...
        # Common failure mode: model emits LaTeX as \left, \frac, etc. inside JSON strings.
